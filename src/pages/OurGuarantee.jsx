      ...
      <section>
        <div className="-tracking-[0.075px] mt-8 bg-[#f0fdfa] border-l-4 border-[#06b6d4] text-[#003e5c] px-6 pt-2 pb-2 rounded-lg shadow mb-4 max-w-2xl mx-auto">
          ...
          <p className="tracking-[0.05px] border-l-4 border-[slategray] text-[#333] max-w-2xl font-lato text-center text-lg font-semibold mb-8 mx-auto leading-8">
            We believe buying land should feel solid, safe, and smart. So here’s
            our promise to you: If you don’t love your land, you don’t have to
            keep it.
          </p>
        </div>
        ...
        <div className="bg-[#f0fdfa] border-l-4 border-[#06b6d4] text-[#003e5c] px-6 pt-5 pb-5 rounded-lg shadow mt-4 mb-8 max-w-2xl mx-auto">
          ...
          <p className="text-[#333] my-3 max-w-3xl mx-auto font-lato leading-6 tracking-[0.05px]">
            ...
            wherein we reclaim the deed, or offer to swap your property out for
            another in our portfolio.
          </p>
          <p className="text-[#333] mb-3 max-w-3xl mx-auto font-lato leading-6 tracking-[0.05px]">
            With no hidden fees, and no hassle: Covered Bridge Properties never
            pressures anyone to buy; let alone to hold. Our mission is simply to
            make it simple to look at any of our listings and decide to find the
            right reasons needed for buying that certain plat today which you'll
            start to see yourself come to love and cherish for many tomorrows,
            looking back on a day like today in the weeks, months, and even
            years to come as the start of that decision. In saying so, we stand
            behind our land, unlike our many competitors having "different"
            priorities.
          </p>
          <p className="text-[#333] mb-4 max-w-3xl mx-auto font-lato leading-6 tracking-[0.05px]">
            So, as you find yourself thinking about what could be, what are you
            waiting for? You can find out how we've built our sales process
            around trust and quality, first hand. And with that in mind, feel
            free to take a look at our current offerings:
          </p>

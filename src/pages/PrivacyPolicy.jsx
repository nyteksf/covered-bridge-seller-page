            ...
            <main className="flex-1 max-w-3xl mx-auto px-8 py-8">
              ...
              <section className="mb-8">
                ...
                <ul className="list-disc list-inside space-y-1">
                  ...
                  <li>
                    <strong>Property Info:</strong> Details about property
                    you're selling
                  </li>
                  <li>
              ...
              <section className="mb-8">
                ...
                <ul className="list-disc list-inside space-y-1">
                  <li>
                    <strong>Service Providers:</strong> Title, escrow, legal
                    teams
                  </li>
                  <li>
              ...
              <section className="mb-8">
                ...
                <p>
                  We do not knowingly collect data from those under 18 years
                  old.
                </p>
              </section>
              ...
              <section className="mb-8">
                ...
                <p>
                  This policy and its details may change at any time. Revisit
              ...
              <section className="mb-8">
                ...
                <p>
                  ...
                  Properties is a registered trademark and brand of Covered
                  Bridge Property Holdings LLC
                </p>
              </section>
            </main>

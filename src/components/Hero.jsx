      ...
      <div className="absolute z-1 text-center max-w-2xl left-1/2 top-1/2 transform -translate-x-1/2 -translate-y-1/2">
        <div className="flex flex-col md:flex-row gap-6 justify-center">
          <a
            ...
            className="hover:text-cyan-200 hover:border-white border-4 border-cyan-200 px-6 pt-1.5 pb-[0.35rem] font-montserrat text-[22px] text-center mt-0 mb-0 tracking-wide uppercase cursor-pointer bg-[#131313] rounded-none flex-none transition-all duration-200 font-extrabold h-[52px] w-[251.1px] py-3 shadow-[0_0_4px_rgba(0,255,255,0.35)] hover:shadow-[0_0_6px_rgba(255,255,255,0.5)]"
          >
            Buy Property
          </a>
          <a

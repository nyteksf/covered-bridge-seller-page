  ...
  return (
    ...
    ${
      isAvailable ? themeMode === "dark-mode"
          ? "border-[#3f3f3f] border !text-white bg-[#181818] hover:border-[#f5f5f5] hover:!text-cyan-400 cursor-pointer"
          : "border-[#181818] border text-[#f5f5f5] bg-[#333] opacity-85 cursor-pointer hover:text-cyan-300 hover:opacity-80"

        : "bg-[#0000] text-gray-300 cursor-not-allowed border"
    } 
    ${selectedStates.includes(state) ? `${ themeMode === "dark-mode" ? "border-black bg-[black] hover:bg-[#181818] !text-cyan-300" : "border-black text-cyan-200 bg-[#181818]" }` : `${ themeMode === "dark-mode" ? "" : "" }` }
  `}
            >
              <input
                type="checkbox"
                ...
                className={`mr-2 accent-cyan-300 w-[14px] h-[14px] ${ themeMode === "dark-mode" ? "bg-[#f5f5f5]" : "bg-white" }`}
              />
              {state}
            </label>
          );
